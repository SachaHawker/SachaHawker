...
create or replace temp table TD10_Barcodes as
Select
a.flowchartname,
a.campaignname,
a.flowchartid,
...
-- adding dates
Create or replace table TD10 as
Select
*,
...
create or replace table TD10_transaction as
select distinct
...
select * from TD10_Red;

select count (distinct ec_id) from TD10_Red where segment is null;
