...
where a. sub_category  in (691,817);
...
--          and a.transaction_date >= (current_date-180)
            ...
            and SKU.sub_category  in (691,817)

      group by 1,2 ;

select count(*) from Olive_Antipasti; --25234308
select * from Olive_Antipasti limit 5;
...
create or replace temp table Olive_Antipasti_trans as
    select *,
           SUM_EXTENDED_PRICE/NUM_TRANSACTIONS as avg_spd
    from Olive_Antipasti
    where 1=1
      -- and avg_margin > 0.33
...
from Olive_Antipasti_trans;

--1.97500000000,2.42500000000,2.93750000000
